...
class MaskFormerPanopticDatasetMapperWithStereo(MaskFormerSemanticDatasetMapper):
    """
    ...
    def __call__(self, dataset_dict):
        ...
        # apply the same transformation to right image
        ...
        right_image = torch.as_tensor(np.ascontiguousarray(right_image.transpose(2, 0, 1)))
        ...
        if self.size_divisibility > 0:
            ...
            right_image = F.pad(right_image, padding_size, value=128).contiguous()
